...
public class BazaarSellModel : BazaarTableModel
{
    public BazaarSellModel(ILogger<BazaarSellModel> logger) : base(logger) { }
    ...
    public override async Task<IActionResult> HTMX_Get()
    {
        ...
        List<BazaarItem> result = await MongoBot.BazaarSell.FindList(filter);
